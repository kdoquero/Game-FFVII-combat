...
class Perso1 extends Persorev {
    constructor(){
        ...
        super("Cloud", 250, 50, 7, 4, 4, 250,"perso1",[normalAttack,contreTaillade,climHazard,omniSlash,firebolt,bahamut,blockAct,itemAct],50,1,0,"perso1dead",document.querySelector('.perso1'));
    }
}