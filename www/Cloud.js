...
class Perso1 extends Persorev {
    constructor(){
        ...
        let firebolt = new Skill ("Firebolt",6,20,"perso1mag1");
        ...
        super("Cloud", 250, 50, 7, 4, 4, 250,"perso1",[normalAttack,contreTaillade,climHazard,omniSlash,firebolt,bahamut,blockAct,itemAct],50,1,0,"perso1dead");
    }
}