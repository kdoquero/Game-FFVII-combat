class Perso2 extends Persorev {
    constructor(){
        ...
        let xzoolomid = new Skill("Xzoolomid",0,11,"perso2invo1","assets/audio/hit.wav");
        ...
        super("Sephiroth", 200, 35, 14, 2, 2, 200,"perso2",[normalattack, sectionx, spaceSlash,xcross,blockAct2,itemAct2,deadPerso2,xzoolomid,cloudFire],35,1,0,"perso2dead");
    }
