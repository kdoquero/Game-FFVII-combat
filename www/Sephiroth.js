class Perso2 extends Persorev {
    constructor(){
        ...
        super("Sephiroth", 250, 35, 14, 2, 2, 250,"perso2",[normalattack, sectionx, spaceSlash,xcross,blockAct2,itemAct2,deadPerso2,xzoolomid,cloudFire],35,1,0,"perso2dead",document.querySelector('.perso2'));
    }
