class Perso2 extends Persorev {
    constructor(){
        ...
        let itemAct2 = new Skill ('Ether',0,0,"perso2item2");
        ...
        super("Sephiroth", 300, 35, 14, 2, 2, 300,"perso2",[normalattack, sectionx, spaceSlash,xcross,blockAct2,itemAct,deadPerso2,xzoolomid,itemAct2,buff2,limitbreak2],35,1,0,"perso2dead",document.querySelector('.perso2'));
    }
